...
class _BuildDesktopViewState extends State<BuildDesktopView> {
  ...
  void initState() {
    ...
    BlocProvider.of<ChatScreenBloc>(context)
        .add(ChatScreenEvent(groupId: "", isAdmin: true));
  }
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              decoration:
                                  const BoxDecoration(color: AppColors.bg),
                              child: Row(
                                mainAxisAlignment:
                            ...
                            Responsive.isDesktop(context)
                                ...
                                : SizedBox.shrink(),
                            Expanded(
                                child: BuildChatList(isAdmin: isAdmin ?? false))
                          ],
                        ),
                      ),
                      Container(
