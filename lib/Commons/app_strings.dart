class AppStrings {
  static const String appName = 'CPSCOM';
  static const String appNameInFirebase = 'cpscom-aea2f';
  static const String serverKey =
      'key=AAAA5ViOPu4:APA91bEzBtutCFr5m-sTpWMatu1ZYiwzGOi8OqqT36QFikwojDaE9FXg3YLeou7RNH2o8qyNbWuYHl-GDLrX0OuwWhbU9b2uo1tSofhPDKH5MS4ApE_Fih0W1Ajj66aEC4KmhUz5HhJ9';

  static const String imagePath =
      'https://excellis.co.in/derick-veliz-admin/public/storage/';

  static final List<String> profileListItems = [
    'Edit Profile',
    'Change Password'
  ];
